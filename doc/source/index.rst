...
intercomparisons between columns from earth system models and observations from active
remote-sensing instruments such as radars and lidars.

EMC^2 is inspired from past work comparing remotely sensed zenith-pointing measurements to earth
system and global climate models (GCMs) and their single-column model modes (SCMs)
