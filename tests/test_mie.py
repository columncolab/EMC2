...
def test_mie_liquid():
    ...
    KAZR_mie = emc2.scattering.scat_properties_water(KAZR.mie_table["cl"].p_diam * 1e6, KAZR.wavelength * 1e-4, 20.)
...
def test_mie_ice():
    KAZR = emc2.core.instruments.KAZR('nsa')
    KAZR_mie = emc2.scattering.scat_properties_ice(KAZR.mie_table["ci"].p_diam * 1e6, KAZR.wavelength * 1e-4, 0.)
